...
PARSE_ERROR_MESSAGES = {
    ...
    "service_disabled": "Автоматическое распознавание событий отключено. Создай событие вручную в приложении.",
}
...
STT_ERROR_MESSAGES = {
    ...
    "service_disabled": "Функция голосовых сообщений отключена. Напиши текстом или создай событие в приложении.",
}
