[![Build & Test](https://github.com/agsamkin/sharedplan-bot/actions/workflows/ci.yml/badge.svg)](https://github.com/agsamkin/sharedplan-bot/actions/workflows/ci.yml)
...
<table>
  <tr>
    <td align="center"><img src="docs/screenshots/spaces.png" width="250" height="450" /><br /><b>Пространства</b></td>
    <td align="center"><img src="docs/screenshots/events.png" width="250" height="450" /><br /><b>События</b></td>
    <td align="center"><img src="docs/screenshots/event-create.png" width="250" height="450" /><br /><b>Создание события</b></td>
  </tr>
  <tr>
    <td align="center"><img src="docs/screenshots/event-detail.png" width="250" height="450" /><br /><b>Детали события</b></td>
    <td align="center"><img src="docs/screenshots/members.png" width="250" height="450" /><br /><b>Участники</b></td>
    <td align="center"><img src="docs/screenshots/reminders.png" width="250" height="450" /><br /><b>Напоминания</b></td>
  </tr>
</table>
</details>
...
Откройте [@BotFather](https://t.me/BotFather) в Telegram и создайте нового бота командой `/newbot`. Сохраните полученный токен — он понадобится для `TELEGRAM_BOT_TOKEN`.
...
# Настроить .env (DATABASE_URL или DB_USER + DB_PASSWORD)
cp .env.example .env
...
### 4. Локальный запуск Mini App через HTTPS
